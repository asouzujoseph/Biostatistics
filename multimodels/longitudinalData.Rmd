...
interaction.plot(AGE,IDNR,MEASURE, xlab="Age in years", ylab="Distance",legend=F, col = "purple")
```
<br>
Boxplots <br>
```{r}
boxplot(MEASURE~AGE,xlab="Age (in years)",ylab="Distance", col = "red")
```
...
```{r}
par(mfrow=c(1,1))
boxplot(MEASURE[SEX==1]~AGE[SEX==1],main="Male gender",main="Male gender",xlab="Age (in years)",ylab="Distance", col = "red")

boxplot(MEASURE[SEX==2]~AGE[SEX==2],main="Female gender", main="Female gender",xlab="Age (in years)",ylab="Distance", col = "pink")
```
<br>
